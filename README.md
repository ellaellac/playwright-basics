...
This repository contains automated E2E tests for `demoqa.com`.

- **CI/CD:** GitHub Actions
- **Reporting:** Allure Reports (hosted on GitHub Pages)
...
3. **View Report:** `npx allure serve allure-results`
